...
const ADDRESSES = {
  MAINNET: {
    ...
    cUSD_cUSDC_FARM_BOT: '0x61e6b1C8AB35dcb7FE1B86f14D52A5A5820Be5d4',
  },
}
...
const cUSD_cUSDC_MAINNET: MobiusFarmBotConfig = {
  name: 'cUSD-cUSDC-mobius',
  abi: MOBIUS_FARM_BOT_ABI,
  farmBotType: 'MOBIUS',
  network: 'MAINNET',
  farmAddress: ADDRESSES.MAINNET.cUSD_cUSDC_FARM_BOT,
  celoStakingToken: ADDRESSES.MAINNET.cUSD,
  bridgeStakingToken: ADDRESSES.MAINNET.cUSDC,
...
export const FARM_BOTS: Record<Network, Record<string, FarmBotConfig>> = {
  MAINNET: {
    ...
    [cUSD_cUSDC_MAINNET.name]: cUSD_cUSDC_MAINNET,
  },
  ALFAJORES: {},
}
