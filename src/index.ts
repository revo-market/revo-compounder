...
export function getFarmBotContract(kit: ContractKit, abi: AbiItem[] | AbiItem, address: string): FarmBotContract {
...
async function getMinAmounts(_paths: [string[], string[]][]): Promise<[number, number][]> {
...
export async function main() {
  const argv = await yargs
    ...
    .option('deadline-seconds-ahead', {
      description: 'How far ahead the deadline for the transaction should be, in seconds',
      type: 'number',
